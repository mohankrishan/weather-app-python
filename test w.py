...
class Weather(Tk):
    def __init__(self):
        ...
        self.iconbitmap(r"./images/www.png")
    ...
    def __gui(self):
       ...
       self.img3=Image.open(r"./images/main.png")
    ...
    def __get_weather(self):
        try:
            ...
            api_key='97338d3c4055f0a2bee9cb4d6dac1ddf'
            ...
            if response.status_code == 200:
               ...
               self.__set_information(weather=weatherData)
            else: 
